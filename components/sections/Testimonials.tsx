...
const TESTIMONIALS: Testimonial[] = [
  {
    id: 1,
    quote: "Edroyt doesn't just run campaigns — they build movements. Their ability to turn a complex vision into a story that actually lands is something I haven't seen anywhere else. Pure creative firepower.",
  ...
  {
    id: 2,
    quote: "Project after project, Edroyt delivers. Stunning interfaces, sharp marketing instincts, and a team that genuinely collaborates. Their commitment to excellence isn't a tagline — it shows in every deliverable.",
    name: "Nikhil Kheradi",
  ...
  {
    id: 3,
    quote: "Edroyt didn't just execute a brief — they got under the skin of our brand. The identity they built for Grower and Musoulic was spot on. Clear communication, zero hand-holding needed, and results that speak for themselves.",
    name: "Grover Amit",
  ...
  {
    id: 4,
    quote: "Fast, professional, and refreshingly easy to work with. Edroyt delivered exactly what we needed — on time and above expectations. Already planning our next collaboration.",
  ...
  {
    id: 5,
    quote: "Edroyt is the engine behind our global strategy at mEinstein. They don't just understand the market — they anticipate it. Their execution is what turned our vision into real user adoption.",
    name: "Prashant Kumar",
  ...
  {
    id: 6,
    quote: "Edroyt operates at a level most design teams can't touch. Research-backed, data-driven, and detail-obsessed. If you need UX that actually converts — they're the ones to call.",
    name: "Pooja Kulkarni",
    role: "Client",
    color: "dark",
  },
  {
    id: 7,
    quote: "Worked with Edroyt on a data dashboard project and they nailed it. They bridged the gap between data complexity and design clarity effortlessly. Sincere, sharp, and highly dependable.",
